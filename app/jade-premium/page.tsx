    ...
    <div className="min-h-screen bg-white">
      ...
      <section id="hero" className="relative h-screen overflow-hidden">
        ...
        <div className="absolute top-24 right-8 z-20">
          <Badge className="bg-[#192849]/90 text-white px-4 py-2 backdrop-blur-sm">Exclusivo</Badge>
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 h-full flex items-center justify-center">
          <div className="text-center text-white max-w-4xl">
            ...
            >
              <Button
                size="lg"
                className="bg-[#192849] hover:bg-[#192849]/90 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 px-8 py-4 text-lg"
                onClick={() => setShowContact(true)}
              >
      ...
      <section id="residencias" className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div {...fadeIn}>
              <span className="text-sm text-[#192849] font-medium tracking-wider uppercase mb-4 block">
                O Endereço que Define Exclusividade
              </span>
              <h2 className="text-4xl md:text-5xl font-light text-gray-900 mb-8 leading-tight">
                Uma oportunidade rara para quem busca <span className="text-[#192849]">distinção</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {jadePremium.diferenciais.map((diferencial, index) => (
                  ...
                  >
                    <div className="w-10 h-10 bg-[#192849]/5 rounded-lg flex items-center justify-center flex-shrink-0">
                      <diferencial.icon className="h-5 w-5 text-[#192849]" />
                    </div>
                    <div>
      ...
      <section id="galeria" className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <motion.div {...fadeIn} className="text-center mb-16">
            <span className="text-sm text-[#192849] font-medium tracking-wider uppercase">Galeria Exclusiva</span>
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mt-4 mb-6">
              Arquitetura que Inspira, <span className="text-[#192849]">Design que Encanta</span>
            </h2>
          ...
          <motion.div {...fadeIn} className="text-center mt-12">
            <Button
              size="lg"
              variant="outline"
              className="border-[#192849]/20 text-[#192849] hover:bg-[#192849]/5 bg-transparent"
            >
      ...
      <section id="plantas" className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <motion.div {...fadeIn} className="text-center mb-16">
            <span className="text-sm text-[#192849] font-medium tracking-wider uppercase">
              Studios Inteligentes & Especificações
            </span>
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mt-4 mb-6">
              Espaços Otimizados, <span className="text-[#192849]">Acabamentos Exclusivos</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-6xl mx-auto">
            ...
            <motion.div {...fadeIn} className="space-y-8">
              <div>
                ...
                <div className="text-3xl font-bold text-[#192849] mb-6">{jadePremium.studio.preco}</div>
              </div>
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-[#192849]/20 text-[#192849] hover:bg-[#192849]/5 bg-transparent w-full"
              >
      ...
      <section id="experiencias" className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <motion.div {...fadeIn} className="text-center mb-16">
            <span className="text-sm text-[#192849] font-medium tracking-wider uppercase">Experiências Premium</span>
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mt-4 mb-6">
              Comodidades Pensadas para seu <span className="text-[#192849]">Conforto</span>
            </h2>
          </motion.div>
              ...
              <motion.div key={index} {...fadeIn} transition={{ delay: index * 0.1 }}>
                <Card className="h-full hover:shadow-xl transition-all duration-500 border-0 shadow-lg">
                  <CardContent className="p-8">
                    <div className="w-16 h-16 bg-[#192849]/5 rounded-xl flex items-center justify-center mb-6">
                      <experiencia.icon className="h-8 w-8 text-[#192849]" />
                    </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            <motion.div {...fadeIn}>
              ...
              <h2 className="text-4xl md:text-5xl font-light text-gray-900 mt-4 mb-8">
                No Epicentro Cultural de <span className="text-[#192849]">São Paulo</span>
              </h2>
                    ...
                    <div className="space-y-3">
                      {categoria.items.map((item, itemIndex) => (
                        ...
                        >
                          ...
                          <Badge variant="outline" className="text-[#192849] border-[#192849]/20">
                            {item.distancia}
                          </Badge>
                        </div>
                      ))}
              ...
              <div className="mt-8 p-6 bg-[#192849]/5 rounded-lg border border-[#192849]/10">
            ...
            <motion.div {...fadeIn}>
              <div className="bg-gray-100 rounded-lg h-[600px] flex items-center justify-center relative overflow-hidden">
                <div className="text-center z-10">
                  <MapPin className="h-16 w-16 text-[#192849] mx-auto mb-4" />
                ...
                <div className="absolute top-1/4 left-1/3 w-3 h-3 bg-[#192849] rounded-full animate-pulse"></div>
      ...
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <motion.div {...fadeIn} className="text-center mb-16">
            <span className="text-sm text-[#192849] font-medium tracking-wider uppercase">Diferenciais Únicos</span>
            <h2 className="text-4xl md:text-5xl font-light text-gray-900 mt-4 mb-6">
              Atributos que Definem <span className="text-[#192849]">Exclusividade</span>
            </h2>
          </motion.div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl mx-auto">
            <motion.div {...fadeIn} className="text-center mb-12">
              ...
              <h2 className="text-4xl md:text-5xl font-light text-gray-900 mt-4 mb-6">
                Agende sua <span className="text-[#192849]">Visita Exclusiva</span>
              </h2>
