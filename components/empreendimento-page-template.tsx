...
import { MapPin, Home, ArrowLeft, Bath, Car, Ruler, Phone, Download, CheckCircle } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Card, CardContent } from "@/components/ui/card"
import { Badge } from "@/components/ui/badge"
import type { Empreendimento } from "@/lib/types/empreendimento"

interface EmpreendimentoPageTemplateProps {
  empreendimento: Empreendimento
}

export default function EmpreendimentoPageTemplate({ empreendimento }: EmpreendimentoPageTemplateProps) {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-8 leading-relaxed">{empreendimento.descricao}</p>
              ...
              {empreendimento.plantas.map((planta, index) => (
                <Card key={index} className="overflow-hidden hover:shadow-lg transition-shadow">
                  <div className="aspect-video bg-gray-100 relative">
                    <Image src={planta.imagem || "/placeholder.svg"} alt={planta.tipo} fill className="object-cover" />
                  </div>
                  <CardContent className="p-6">
                    ...
                    <div className="text-center">
                      <div className="text-2xl font-bold text-secondary mb-2">{planta.preco}</div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {empreendimento.galeria.map((imagem, index) => (
                <div
                  key={index}
                  className="relative aspect-video bg-gray-100 rounded-lg overflow-hidden group hover:shadow-lg transition-shadow"
                >
                  <Image
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-100 rounded-lg p-8 text-center">
              ...
              <p className="text-gray-600 mb-6">Localização privilegiada com excelente infraestrutura urbana.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section
        ...
        style={{ backgroundColor: empreendimento.identidadeVisual.corPrimaria }}
      >
