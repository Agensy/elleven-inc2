        ...
        >
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-1 space-y-6">
            <Link href="/" className="flex items-center gap-3 mb-6">
              <img src="/logo-elleven-white.png" alt="Elleven Engenharia" className="h-14 w-auto" />
            </Link>
            <p className="text-white/80 leading-relaxed mb-6" style={{ fontSize: "0.875rem" }}>
              Muito além do aço e concreto, construímos sonhos. Empreendimentos premium com inovação, qualidade e
              sustentabilidade.
            </p>
          ...
          <motion.div variants={fadeInUp}>
            <h3 className="text-white font-semibold mb-6" style={{ fontSize: "1rem" }}>
              Links Rápidos
            </h3>
