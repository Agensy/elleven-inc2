...
const timeElleven = [
  ...
  },
  {
    ...
    imagem: "/team/fernando-remor.png",
    descricao:
  ...
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-16 relative z-10">
        ...
        >
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-foreground mb-4">Quem somos nós</h2>
