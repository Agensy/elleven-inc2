...
function ConteudoTexto({ fadeInLeft }: { fadeInLeft: any }) {
  return (
    <motion.div variants={fadeInLeft} initial="initial" whileInView="whileInView" viewport={{ once: true }}>
      {/* Título */}
      <h2
        className="text-2xl md:text-3xl lg:text-4xl font-bold uppercase mb-6 text-glow-xs"
        style={{ color: "#1A2D54" }}
      >
      ...
      <div className="space-y-6 mb-8">
        <p className="text-muted-foreground leading-relaxed" style={{ fontSize: "0.875rem" }}>
          Há mais de 15 anos no mercado, a Elleven Engenharia se consolidou como referência em empreendimentos de alto
          padrão. Nossa missão é transformar sonhos em realidade através de projetos inovadores que combinam design
          excepcional, qualidade superior e sustentabilidade.
        </p>

        <p className="text-muted-foreground leading-relaxed" style={{ fontSize: "0.875rem" }}>
          Trabalhamos com os mais altos padrões de qualidade e excelência, sempre buscando superar as expectativas dos
          nossos clientes. Nossa equipe de profissionais altamente qualificados está comprometida em entregar projetos
          que não apenas atendam, mas superem as expectativas.
        </p>

        <p className="text-muted-foreground leading-relaxed" style={{ fontSize: "0.875rem" }}>
          Com um portfólio diversificado de empreendimentos residenciais e comerciais, a Elleven Engenharia se destaca
          pela atenção aos detalhes, uso de tecnologias avançadas e compromisso com prazos e orçamentos.
        </p>
      </div>
