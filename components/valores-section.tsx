...
const valores = [
  {
    ...
    titulo: "Respeito",
    descricao:
      "Clientes, colaboradores, investidores e parceiros são nossas prioridades. Respeitar as suas necessidades é fundamental.",
  },
  {
    icon: Zap,
    titulo: "Agilidade",
    descricao:
      "Processos otimizados e profissionais capacitados para atender às suas demandas, sempre cumprindo com o prazo.",
  },
  {
    icon: Lightbulb,
    titulo: "Inovação",
    descricao:
      "Com a capacidade para ousar, estamos alinhados com as novas tendências do mercado, em projetos verticais e horizontais.",
  },
  {
    icon: TrendingUp,
    titulo: "Aprimoramento",
    descricao:
      "Estamos em constante qualificação para oferecer um serviço com excelência. A evolução está em nosso sangue.",
  },
]
      ...
      <div className="bg-gradient-to-r from-secondary/10 to-secondary/5 border border-secondary/20 rounded-lg p-8 w-full shadow-light-sm">
        ...
        <div className="space-y-4">
          <p className="text-muted-foreground leading-relaxed text-lg">
            Todo o nosso trabalho é planejado para ser agente transformador na conquista do seu imóvel, empreendimento
            ou investimento.
          </p>

          <p className="text-muted-foreground leading-relaxed text-lg">
            Porque, para nós,{" "}
            <span className="text-secondary font-semibold">o seu sucesso é a nossa maior conquista</span> nessa
            empreitada.
          </p>
        </div>
      </div>
