...
export const empreendimentosCompletos: Record<string, EmpreendimentoData> = {
  ...
  // Outros empreendimentos serão adicionados aqui
  grandClubCotia: {
    id: "grand-club-cotia",
    ...
    destaques: ["198 unidades", "8 Torres", "1 e 2 Dormitórios", "Lazer completo"],
    caracteristicas: [
  ...
  icaraiParqueClube: {
    ...
    destaques: ["408 unidades", "4 Torres", "2 e 3 Dormitórios", "Lazer completo"],
    caracteristicas: [
  ...
  leMont: {
    ...
    destaques: ["150 unidades", "5 Torres", "1 e 2 Dormitórios", "Unidades Garden"],
    caracteristicas: [
  ...
  leMont2: {
    ...
    destaques: ["120 unidades", "4 Torres", "1, 2 e 3 Dormitórios", "Área de lazer completa"],
    caracteristicas: [
